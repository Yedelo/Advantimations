...
public abstract class AvatarRendererMixin {
    @ModifyExpressionValue(method = "setupRotations(Lnet/minecraft/client/renderer/entity/state/AvatarRenderState;Lcom/mojang/blaze3d/vertex/PoseStack;FF)V", at = @At(value = "FIELD", target = "Lnet/minecraft/client/renderer/entity/state/AvatarRenderState;isFallFlying:Z", opcode = Opcodes.GETFIELD))
    ...
    @ModifyExpressionValue(method = "setupRotations(Lnet/minecraft/client/renderer/entity/state/AvatarRenderState;Lcom/mojang/blaze3d/vertex/PoseStack;FF)V", at = @At(value = "FIELD", target = "Lnet/minecraft/client/renderer/entity/state/AvatarRenderState;isVisuallySwimming:Z", opcode = Opcodes.GETFIELD))
    private boolean advantimations$cancelSwimmingAnimation(boolean original, @Local(argsOnly = true) AvatarRenderState state) {
        return AdvantimationsConfig.getInstance().cancelSwimmingAnimation.getThirdPersonResult(state, original, false);
    }
